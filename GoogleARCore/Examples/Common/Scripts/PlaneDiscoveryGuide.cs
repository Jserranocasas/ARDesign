...
namespace GoogleARCore.Examples.Common
{
    ...
    public class PlaneDiscoveryGuide : MonoBehaviour
    {
        ...
        public void hiddenDetectedPlanes()
        {
            Destroy(gameObject);
        }
        ...
        private void _UpdateUI()
        {
            ...
            if (Session.Status == SessionStatus.LostTracking &&
                ...
                (!FirstTimeSelected || ModeAction.Instance.getMode() == ModeStatus.Creation))
            {
                ...
                switch (Session.LostTrackingReason)
                {
                    case LostTrackingReason.InsufficientLight:
                        ...
                        {
                            m_SnackBarText.text = "Trop sombre. Essayez de vous déplacer dans un endroit bien éclairé.";
                        }
                        break;
                    case LostTrackingReason.InsufficientFeatures:
                        ...
                        if (GlobalLanguage.CurrentLanguage == "French")
                        {
                            m_SnackBarText.text = "Visez le périphérique sur une surface avec plus de texture ou de couleur.";
                        }
                        break;
                    case LostTrackingReason.ExcessiveMotion:
                        ...
                        if (GlobalLanguage.CurrentLanguage == "French")
                        {
                            m_SnackBarText.text = "Bouger trop vite. Ralentissez.";
                        }
                        break;
                    default:
                        if (GlobalLanguage.CurrentLanguage == "Spanish")
                        ...
                        if (GlobalLanguage.CurrentLanguage == "French")
                        {
                            m_SnackBarText.text = "Le suivi de mouvement est perdu.";
                        }
                        break;
                }
            ...
            if (m_NotDetectedPlaneElapsed > DisplayGuideDelay)
            {
                ...
                if(!FirstTimeSelected || ModeAction.Instance.getMode() == ModeStatus.Creation){
                    ...
                    if (m_NotDetectedPlaneElapsed > OfferDetailedInstructionsDelay)
                    {
                        ...
                        if (GlobalLanguage.CurrentLanguage == "French")
                        {
                            m_SnackBarText.text = "Besoin d'aide pour?";
                        }
                    ...
                    else
                    {
                        if (GlobalLanguage.CurrentLanguage == "Spanish")
                        {
                            m_SnackBarText.text = "Apunta tu cámara hacia donde quieres colocar un objeto.";
                        }
                        if (GlobalLanguage.CurrentLanguage == "English")
                        {
                        ...
                        if (GlobalLanguage.CurrentLanguage == "French")
                        {
                            m_SnackBarText.text = "Dirigez votre caméra vers l'endroit où vous souhaitez placer un objet.";
                        }
                        m_OpenButton.SetActive(false);
                    }
                }
