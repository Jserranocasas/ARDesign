...
namespace GoogleARCore
{
    ...
    public static class Session
    {
        ...
        /// <summary>
        /// Current Idiom of the session.
        /// </summary>
        private static string currentIdiom = "Spanish";

        /// <summary>
        /// Current selected object.
        /// </summary>
        private static string IdSelectedObject = "";
        
        /// <summary>
        /// List of detected planes.
        /// </summary>
        private static List<GameObject> DetectedPlanes = new List<GameObject>();

        /// <summary>
        /// Dictionary to manager inserted objects.
        /// </summary>
        private static Dictionary<string, GameObject> InsertedObjects = new Dictionary<string, GameObject>();

        /// <summary>
        /// Sets current idiom.
        /// </summary>
        public static void setIdiom(string i)
        {
            i = currentIdiom;
        }
        ...
        /// </summary>
        public static string GetIdCurrentObject()
        {
            return IdSelectedObject;
        }

        /// <summary>
        /// Sets current selected object.
        /// </summary>
        public static void SetIdCurrentObject(string idCurrentObject)
        {
            IdSelectedObject = idCurrentObject;
        }
        ...
        /// <summary>
        /// Gets list detected planes visualizer that ARCore has tracked.
        /// </summary>
        public static List<GameObject> GetDetectedPlanes()
        {
        ...
        {
            if(InsertedObjects.ContainsKey(IdSelectedObject))
            {
                return InsertedObjects[IdSelectedObject];
            }
            else
            {
                return null;
        ...
        /// <summary>
        /// Add plane to list detected planes visualizer.
        /// </summary>
        public static void AddDetectedPlanes(GameObject planeVisualizer)
        {
            DetectedPlanes.Add(planeVisualizer);
        }

        /// <summary>
        /// Add plane to list detected planes visualizer.
        /// </summary>
        public static void AddInsertedObject(string id, GameObject iObject)
        {
            InsertedObjects.Add(id, iObject);
        }
